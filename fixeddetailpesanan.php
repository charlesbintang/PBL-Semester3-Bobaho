...
<body>
    ...
    <h3 id="pesanan">Pesanan Customer :</h3>
        ...
        <div class="Container">
            ...
            <textarea class="form-control" id="Catatan" rows="1" placeholder=></textarea>
        </div>
        ...
        <div class="list-container">
            ...
            <div class="tersedia">
                <button class="button-tersedia" onclick="document.location.href = 'fixedcatatanadmin.php'" type="button"> Lihat Catatan</button>
           </div>
    ...
    <footer id="kaki">
        <div class="footer">
            <button class="HomeButton" onclick="document.location.href = 'login.php'" type="button" >
            ...
            <button class="Keranjang" onclick="document.location.href = 'fixedadminpesanan.php'" type="button">
