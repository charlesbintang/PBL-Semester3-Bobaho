            ...
            <div class="col-md">
                <form action="<?= base_url('admin/tambah') ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" name="harga" placeholder="mis. 14" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="Harga" class="form-label">Rating</label>
                        <input type="text" class="form-control w-50" name="rating" placeholder="mis. 4.9" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
